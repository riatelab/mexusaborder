...
La fonction *`opquery`* permet d'extraire tous les obojets (points/polygones) contenus dans la base de données OSM qui sont inclus dans une bounding box prédéfinie et pour un couple **clé/valeur**. 
...
*deathsdor <- cartogram_dorling(x = st_jitter(iom_ortho),weight = "deads", 
